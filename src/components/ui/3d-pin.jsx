      ...
      >
        ...
        >
          <div
            ...
            className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-md bg-black border border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
          >
        ...
        <div
          ...
          <>
            ...
            <motion.div
              ...
              className="absolute left-1/2 top-1/2  h-[11.25px] w-[11.25rem] rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"></motion.div>
          </>
        </div>
