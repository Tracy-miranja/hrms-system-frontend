...
function Service() {
  ...
  return (
    <div className="flex justify-center px-4 sm:px-6 lg:px-20">
      <div className="flex bg-[#F3F9F1] min-h-screen py-10 w-full rounded-2xl shadow-lg">
        <div className="container mx-auto">
          ...
          <div className="flex justify-center space-x-4 mb-12 overflow-x-auto">
            ...
            <Link to="">
              <button className="text-lg rounded-full bg-yellow-300 p-2 font-semibold hover:bg-blue-200">
                More Services
              </button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.keys(servicesData).map((service) => (
              <PinContainer
                ...
                href="#"
                className={`p-6 rounded-lg shadow-xl transition-all transform-gpu gap-4 ${
                  selectedService === service
                    ? "bg-blue-200"
              ...
              >
                ...
                <p className="mt-2 text-sm sm:text-base">{servicesData[service].description}</p>
              </PinContainer>
            ))}
          </div>
        </div>
